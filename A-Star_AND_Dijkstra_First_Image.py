...
def image_to_maze(image_path, threshold=200):
    """
...
def image_to_graph(image_path, threshold=200):
    """
...
# Example usage:
# image_path = r"C:\Users\agran\Pictures\Screenshots\Newfolder\test5.png"
image_path = r"test5.png"
image = cv2.imread(image_path)
height, width = image.shape[:2]

graph = image_to_graph(image_path)
#         Up/Down  Right/Left
start_node = (140, 427)    # for image "test5"
# end_node = (300, 387)
end_node = (440,230)
# start_node = (151, 470)  for image "test"
# end_node = (451,273)
